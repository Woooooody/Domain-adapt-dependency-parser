...
def test(parser, num_buckets_test, test_batch_size, test_file, output_file):
    #vocab = Vocab(test_file, config.pretrained_embeddings_file, config.min_occur_count)
...
if __name__ == '__main__':
    ...
    test(parser, config.num_buckets_test, config.test_batch_size, config.test_file, args.output_file)
