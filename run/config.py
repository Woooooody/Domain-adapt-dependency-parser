...
class Configurable(object):
	...
	@property
	def wsj_file(self):
		return self._config.get('Data','wsj_file')
	@property
	def answers_file(self):
		return self._config.get('Data', 'answers_file')	
	@property
	def dev_file(self):
	...
	@property
	def domain_num(self):
		return self._config.getint('Network', 'domain_num')	
	@property
	...
	def filter_size(self):
		return self._config.getint('Network', 'filter_size')
